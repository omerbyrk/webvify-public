try {
  if (window.location.pathname.includes("login")) {
    ...
    var loginForm = document.getElementById("youzify-membership-form"); // enter login form selector
    var loginButton = document.getElementsByName("signin_submit")[0]; // enter login form button to copy
