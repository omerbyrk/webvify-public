// https://cdn.jsdelivr.net/gh/omerbyrk/webvify-public/medupdate.js

try {
  if (window.location.pathname.includes("login")) {
    var loginForm = document.querySelector("form.arm_form_106"); // enter login form selector
    var loginButton = document.getElementsByName("armFormSubmitBtn")[0]; // enter login form button to copy
    ...
    registerButton.classList.remove("arm-df__form-control-submit-btn")
