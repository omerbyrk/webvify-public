...
try {
    if (window.location.pathname.includes("mijn-account")) {
        var loginForm = document.querySelector(".account-container"); // enter login form selector
        var loginButton = document.querySelector(".woocommerce-form-login__submit"); // enter login form button to copy
