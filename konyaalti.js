...
try {
  if (window.location.pathname.includes("index.html")) {
    var loginForm = document.querySelector(".login .content"); // enter login form selector
    var loginButton = document.querySelector("button.hidden-xs"); // enter login form button to copy
