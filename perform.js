...
try {
    if (window.location.pathname.includes("learn")) {
        var loginForm = document.querySelector(".login-wrap form"); // enter login form selector
        var loginButton = document.querySelector("button[type='submit']"); // enter login form button to copy
...
try {
    var parentElement = document.querySelector(".user-menu-navigation ul");
