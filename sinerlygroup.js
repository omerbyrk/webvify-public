// https://cdn.jsdelivr.net/gh/omerbyrk/webvify-public/sinerlygroup.js



try {
  var parentElement = document.querySelector(".mepr-profile-wrapper__footer");
...
try {
  if (window.location.pathname.includes("login")) {
    var loginForm = document.getElementsByName("mepr_loginform")[0]; // enter login form selector
    var loginButton = document.getElementById("wp-submit"); // enter login form button to copy
