// https://cdn.jsdelivr.net/gh/omerbyrk/webvify-public/hodenregister.js

try {
  if (window.location.pathname.includes("boeking")) {
    var loginForm = document.querySelector("#loginform"); // enter login form selector
    var loginButton = document.getElementsByName("wp-submit")[0]; // enter login form button to copy
