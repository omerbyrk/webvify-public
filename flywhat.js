// https://cdn.jsdelivr.net/gh/omerbyrk/webvify-public/flywhat.js

try {
  if (window.location.pathname.includes("login")) {
    var loginForm = document.querySelector(".tplogin__form"); // enter login form selector
    var loginButton = document.querySelector(".tp-login-button button"); // enter login form button to copy
