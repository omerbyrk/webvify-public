// https://cdn.jsdelivr.net/gh/omerbyrk/webvify-public/firsat03.js

try {
  if (window.location.pathname.includes("musteri-paneli")) {
    var loginForm = document.querySelector(".am-asi"); // enter login form selector
    var loginButton = document.querySelector(".am-button"); // enter login form button to copy
