...
if (document.location.href.indexOf("profile") !== -1) {
    function addDeleteMyAccountButton() {
        var parentElement = document.querySelector(".main-wrapper");
        ...
        if (parentElement.firstChild.innerText !== deleteMyButton.innerText) {
            parentElement.insertBefore(deleteMyButton, parentElement.firstChild);
        }
    }
